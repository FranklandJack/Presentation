...
\begin{frame}{Results - Harmonic Oscillator Wave Function}
    ...
    \only<3-4>{\begin{block}{Discrete Wave Function\footfullcite{creutz_freedman_1981}}
    \only<3-4>{
    ...
    %\end{equation}}
    \end{block}}
    \only<6>{\begin{block}{Continuous Wave Function}
    \only<6>{
    \begin{equation}
